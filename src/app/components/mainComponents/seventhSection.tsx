  ...
  return (
    <div className="w-full 2xl:h-[989px] bg-[#ffd0ec] flex items-center justify-center">
      <div className="2xl:w-[1640px] 2xl:h-[629px] bg-[#212121] 2xl:flex 2xl:px-28 py-20 justify-between px-8 h-full 2xl:rounded-2xl">
        {/* titles and buttons */}
        <div>
          <h1 className="text-[80px] font-[600] text-white leading-[120px] 2xl:w-[895px] text-center 2xl:text-left">
          ...
          <button className="flex w-[373px] h-[72px] bg-[#ffd0ec] rounded-full items-center justify-center m-auto 2xl:m-0 ">
        ...
        {/* image */}
        <Image src={Rectangle} alt={"Rectangle"} width={567} height={480} className="w-[567px] h-[480px] rounded-xl mt-16 m-auto 2xl:m-0" />
      </div>
    </div>
  );
}
